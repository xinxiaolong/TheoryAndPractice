package com.example.fragment.theoryandpractice.coordinatorLayoutPractice.view;
...
/**
 * Created by xiaolong on 2016/10/19.
 */
...
public class MyListView extends ListView implements NestedScrollingChild {
    ...
    public MyListView(final Context context, final AttributeSet attrs, final int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initHelper();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MyListView(final Context context, final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
