...
public class VerticalStepView extends LinearLayout implements VerticalStepViewIndicator.OnDrawIndicatorListener
{
    ...
    private int mUnComplectedTextColor;//定义默认未完成文字的颜色;
    private int mComplectedTextColor;//定义默认完成文字的颜色;
    ...
    private void init()
    {
        ...
        mUnComplectedTextColor=mContext.getResources().getColor( R.color.uncompleted_text_color);
        mComplectedTextColor=mContext.getResources().getColor(android.R.color.white);
