...
public class HorizontalStepsViewIndicator extends View
{
    ...
    private Drawable mCompleteIcon;//完成的图片    definition default completed icon
    private Drawable mAttentionIcon;//正在进行的图片     definition default underway icon
    private Drawable mDefaultIcon;//背景图  definition default unCompleted icon
    ...
    private int mUnCompletedLineColor = Color.BLUE;//定义默认未完成线的颜色  definition mUnCompletedLineColor
