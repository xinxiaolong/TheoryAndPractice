...
import qktx.xinxiaolong.com.timetask.step.algorithm.StepCount;
import qktx.xinxiaolong.com.timetask.step.algorithm.StepValuePassListener;
...
public class StepService extends Service implements SensorEventListener {
     ...
     * 默认为30秒进行一次存储
     */
    private static int duration = 2 * 1000;
    /**
     * 传感器管理对象
     */
    ...
    public void onCreate() {
        ...
        Log.e(TAG,"StepService:  onCreate()");
        startTimeCount();
        sharedPreferences =getSharedPreferences("qktx", Context.MODE_PRIVATE);
    ...
    private void addBasePedometerListener() {
        ...
        mStepCount.initListener(new StepValuePassListener() {
            ...
            public void stepChanged(int steps) {
                CURRENT_STEP = steps;
                Log.e(getClass().getName(),"stepChanged()   steps="+steps);
            }
        });
        if (isAvailable) {
    ...
    private void save() {
        ...
        sharedPreferences.edit().putInt("recordTotalCount",tempStep).commit();
    }
